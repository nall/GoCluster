...
- Long-running schedulers never stop: `startSkewScheduler` still spins forever without cancelation/shutdown, so embedding/restarts or tests will leak goroutines; add context-driven stop hooks.
