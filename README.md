...
- `call_correction.prior_bonus_*` enables a strict one-short `min_reports` bonus for likely-good calls (for example SCP-known calls) without bypassing advantage/confidence/freq_guard/cooldown gates.
