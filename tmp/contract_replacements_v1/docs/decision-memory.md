...
- preserve the ordering convention already used by that log file
- if the log is chronological ascending, append at the end
- do not reorder existing history solely to match a default convention
