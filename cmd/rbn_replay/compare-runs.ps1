...
$report = [pscustomobject]@{
  ...
  'Applied_A' = IntVal $a.stability.total_applied
  'Applied_B' = IntVal $b.stability.total_applied
  'Applied_Delta' = (IntVal $b.stability.total_applied) - (IntVal $a.stability.total_applied)
  'StablePct_A' = Num $a.stability.stable_pct
  'StablePct_B' = Num $b.stability.stable_pct
  'StablePct_Delta' = [math]::Round((Num $b.stability.stable_pct) - (Num $a.stability.stable_pct), 3)

  'OutputConfUnknown_A' = IntVal $a.ab_metrics.output.confidence_counts.unknown
  'OutputConfUnknown_B' = IntVal $b.ab_metrics.output.confidence_counts.unknown
  'OutputConfUnknown_Delta' = (IntVal $b.ab_metrics.output.confidence_counts.unknown) - (IntVal $a.ab_metrics.output.confidence_counts.unknown)
  'OutputConfP_A' = IntVal $a.ab_metrics.output.confidence_counts.p
  'OutputConfP_B' = IntVal $b.ab_metrics.output.confidence_counts.p
  'OutputConfP_Delta' = (IntVal $b.ab_metrics.output.confidence_counts.p) - (IntVal $a.ab_metrics.output.confidence_counts.p)
  'OutputConfV_A' = IntVal $a.ab_metrics.output.confidence_counts.v
  'OutputConfV_B' = IntVal $b.ab_metrics.output.confidence_counts.v
  'OutputConfV_Delta' = (IntVal $b.ab_metrics.output.confidence_counts.v) - (IntVal $a.ab_metrics.output.confidence_counts.v)
  'OutputConfC_A' = IntVal $a.ab_metrics.output.confidence_counts.c
  'OutputConfC_B' = IntVal $b.ab_metrics.output.confidence_counts.c
  'OutputConfC_Delta' = (IntVal $b.ab_metrics.output.confidence_counts.c) - (IntVal $a.ab_metrics.output.confidence_counts.c)
  'OutputConfB_A' = IntVal $a.ab_metrics.output.confidence_counts.b
  'OutputConfB_B' = IntVal $b.ab_metrics.output.confidence_counts.b
  'OutputConfB_Delta' = (IntVal $b.ab_metrics.output.confidence_counts.b) - (IntVal $a.ab_metrics.output.confidence_counts.b)
  ...
  'ResolverBayesReportConsidered_A' = IntVal $a.ab_metrics.resolver.bayes_report_considered
  'ResolverBayesReportConsidered_B' = IntVal $b.ab_metrics.resolver.bayes_report_considered
  'ResolverBayesReportConsidered_Delta' = (IntVal $b.ab_metrics.resolver.bayes_report_considered) - (IntVal $a.ab_metrics.resolver.bayes_report_considered)
  'ResolverBayesReportApplied_A' = IntVal $a.ab_metrics.resolver.bayes_report_applied
  'ResolverBayesReportApplied_B' = IntVal $b.ab_metrics.resolver.bayes_report_applied
  'ResolverBayesReportApplied_Delta' = (IntVal $b.ab_metrics.resolver.bayes_report_applied) - (IntVal $a.ab_metrics.resolver.bayes_report_applied)
  'ResolverBayesReportRejected_A' = IntVal $a.ab_metrics.resolver.bayes_report_rejected
  'ResolverBayesReportRejected_B' = IntVal $b.ab_metrics.resolver.bayes_report_rejected
  'ResolverBayesReportRejected_Delta' = (IntVal $b.ab_metrics.resolver.bayes_report_rejected) - (IntVal $a.ab_metrics.resolver.bayes_report_rejected)
  'ResolverBayesAdvantageConsidered_A' = IntVal $a.ab_metrics.resolver.bayes_advantage_considered
  'ResolverBayesAdvantageConsidered_B' = IntVal $b.ab_metrics.resolver.bayes_advantage_considered
  'ResolverBayesAdvantageConsidered_Delta' = (IntVal $b.ab_metrics.resolver.bayes_advantage_considered) - (IntVal $a.ab_metrics.resolver.bayes_advantage_considered)
  'ResolverBayesAdvantageApplied_A' = IntVal $a.ab_metrics.resolver.bayes_advantage_applied
  'ResolverBayesAdvantageApplied_B' = IntVal $b.ab_metrics.resolver.bayes_advantage_applied
  'ResolverBayesAdvantageApplied_Delta' = (IntVal $b.ab_metrics.resolver.bayes_advantage_applied) - (IntVal $a.ab_metrics.resolver.bayes_advantage_applied)
  'ResolverBayesAdvantageRejected_A' = IntVal $a.ab_metrics.resolver.bayes_advantage_rejected
  'ResolverBayesAdvantageRejected_B' = IntVal $b.ab_metrics.resolver.bayes_advantage_rejected
  'ResolverBayesAdvantageRejected_Delta' = (IntVal $b.ab_metrics.resolver.bayes_advantage_rejected) - (IntVal $a.ab_metrics.resolver.bayes_advantage_rejected)
